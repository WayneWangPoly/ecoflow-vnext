...
const predecessor = {
  id: '7d464f58-7305-433b-a618-dcaeb31d820d',
  status: 'SUCCEEDED',
  assets_planned: 10,
  assets_copied: 10,
  assets_reused: 0,
  assets_failed: 0,
  bytes_copied: 3376311,
...
console.log('W37 bounded predecessor/authorization/result checks passed');
