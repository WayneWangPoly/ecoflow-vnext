...
const predecessor = {
  id: 'c9d04dbd-53eb-435d-8006-3f49834d0d86',
  status: 'SUCCEEDED',
  assets_planned: 10,
  assets_copied: 10,
  assets_reused: 0,
  assets_failed: 0,
  bytes_copied: 2557686,
...
console.log('W34 bounded predecessor/authorization/result checks passed');
