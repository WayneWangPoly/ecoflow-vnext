...
const predecessor = {
  id: '8756d3be-a8f3-4408-adaf-18f7e9c0605e',
  status: 'SUCCEEDED',
  assets_planned: 10,
  assets_copied: 10,
  assets_reused: 0,
  assets_failed: 0,
  bytes_copied: 1738402,
...
console.log('W36 bounded predecessor/authorization/result checks passed');
