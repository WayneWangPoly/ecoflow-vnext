...
insert into public.skus(id,sku_code,display_name,category,setup_status) values
  ('aaaaaaaa-0000-4000-8000-000000000010','CANARY-BPB8','Catalog context only: 8oz Kraft Soup Bowl Carton - 250ml - 1000pcs','Bowls','mapping_draft');
insert into public.external_product_mappings(
  ...
  'ORDERMENTUM','CANARY-BPB8','aaaaaaaa-0000-4000-8000-000000000010','unconfigured','BOUNDED_COMMERCIAL_PROMOTION',true
);
...
begin
  ...
  if not exists(
    ...
    where l.commercial_sku_id='aaaaaaaa-0000-4000-8000-000000000010'::uuid
