...
const predecessor = {
  id: '82b41005-fbe8-4bac-80b4-85ce34d775cb',
  status: 'SUCCEEDED',
  assets_planned: 10,
  assets_copied: 10,
  assets_reused: 0,
  assets_failed: 0,
  bytes_copied: 4447008,
...
console.log('W31 bounded predecessor/authorization/result checks passed');
