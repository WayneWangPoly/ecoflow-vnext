...
const predecessor = {
  id: '2a857937-ff68-49e8-9f2c-a3b99c5766ea',
  status: 'SUCCEEDED',
  assets_planned: 10,
  assets_copied: 10,
  assets_reused: 0,
  assets_failed: 0,
  bytes_copied: 4779765,
...
console.log('W32 bounded predecessor/authorization/result checks passed');
