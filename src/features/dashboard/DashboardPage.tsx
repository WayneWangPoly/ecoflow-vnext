...
export function DashboardPage({
  ...
  const todayNeedsDecision = stageCount(todayCommissioningView, 'NEEDS_ACTION') + stageCount(todayCommissioningView, 'FINANCE_REVIEW');
  const todayReady = stageCount(todayCommissioningView, 'READY');
  const todayWarehouse = stageCount(todayCommissioningView, 'WAREHOUSE');
  const todayStaged = stageCount(todayCommissioningView, 'STAGED');
  const todayRoute = stageCount(todayCommissioningView, 'ROUTE');
