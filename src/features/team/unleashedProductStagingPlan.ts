...
export const PRODUCT_STAGING_PLAN = {
  ...
  overlapBudget: {
    ...
    consumed: 1,
    remaining: 0,
    rule: 'The single historical overlap was consumed by P1 as one unchanged row. P2 and P3 must therefore be pure inserts with recordsChanged=0 and recordsUnchanged=0.',
  },
  expectedSequence: [
    ...
    { window: 'P2', startPage: 2, maxPages: 1, expectedRowsSeen: 200, previousRunId: '162e9838-bcb1-45b9-84c3-334bca8c202c', expectedWindowComplete: false, expectedNextPage: 3, status: 'EXPOSED' },
