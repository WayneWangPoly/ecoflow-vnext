...
const BatchNext5P3ResumePublishCarrier = lazy(() => import('./BatchNext5P3ResumePublishCarrier').then((module) => ({ default: module.BatchNext5P3ResumePublishCarrier })));
  ...
  return (
    <>
      <Suspense fallback={null}>
        <BatchNext5P3ResumePublishCarrier
          role={props.role}
