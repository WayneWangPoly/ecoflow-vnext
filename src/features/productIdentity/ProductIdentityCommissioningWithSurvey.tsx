...
const BatchNext5P2ResumeSubmitCarrier = lazy(() => import('./BatchNext5P2ResumeSubmitCarrier').then((module) => ({ default: module.BatchNext5P2ResumeSubmitCarrier })));
  ...
  return (
    <>
      <Suspense fallback={null}>
        <BatchNext5P2ResumeSubmitCarrier
          role={props.role}
