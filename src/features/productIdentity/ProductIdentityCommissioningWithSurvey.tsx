...
const BatchNext4DraftOnlyCarrier = lazy(() => import('./BatchNext4DraftOnlyCarrier').then((module) => ({ default: module.BatchNext4DraftOnlyCarrier })));
