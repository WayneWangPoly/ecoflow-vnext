...
const BatchNext5DraftOnlyCarrier = lazy(() => import('./BatchNext5DraftOnlyCarrier').then((module) => ({ default: module.BatchNext5DraftOnlyCarrier })));
