...
const BatchNext4P3ResumePublishCarrier = lazy(() => import('./BatchNext4P3ResumePublishCarrier').then((module) => ({ default: module.BatchNext4P3ResumePublishCarrier })));
  ...
  return (
    <>
      <Suspense fallback={null}>
        <BatchNext4P3ResumePublishCarrier
          role={props.role}
