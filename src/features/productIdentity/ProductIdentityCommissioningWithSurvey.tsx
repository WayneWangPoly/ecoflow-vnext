...
const BatchNext4P2ResumeSubmitCarrier = lazy(() => import('./BatchNext4P2ResumeSubmitCarrier').then((module) => ({ default: module.BatchNext4P2ResumeSubmitCarrier })));
  ...
  return (
    <>
      <Suspense fallback={null}>
        <BatchNext4P2ResumeSubmitCarrier
          role={props.role}
