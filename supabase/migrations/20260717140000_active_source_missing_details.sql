-- Expose the exact source-missing orders that still have a live EcoFlow
-- internal workflow. This is a small service-role diagnostic contract used by
-- complete-mirror verification and persisted into the Settings health snapshot.
